...
const Info = () => {
  ...
  const getHeartImage = (index: number, ratingg = -1): string => {
    if (ratingg === -1) {
      if (index < rating) {
  ...
  return (
    <div className="px-2 md:mt-10 px-10">
            ...
            <div key={idx} className='mb-10'>
              ...
              <div className="flex gap-4 md:gap-8">
                ...
                <span className="text-lg font-medium md:text-4xl">
                  ...
                  <div className='flex'>
                    {[...Array(5)].map((_, index) => (
                      <div key={index} className={`w-[2.5rem] h-[2.5rem]`}>
                        <img
                          src={getHeartImage(index, review.rating)}
                          alt="Heart"
      ...
      <div className="flex justify-end mt-3 pr-3 md:mt-5 mb-14">
      ...
      <div className="bg-brown-200 p-6 rounded-lg w-full">
        ...
        <div className="flex justify-end mt-4">
          <button
            ...
            className="bg-[#F0BB81] px-3 rounded-[20px] text-[16px] font-bold text-[#5D462D] md:text-[32px] md:px-8 py-1">
            Add new review
          </button>
        </div>
      </div>
